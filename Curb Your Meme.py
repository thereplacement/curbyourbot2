...
consumer_secret = 'YBTRHbRoh1DrvWEhheHfhewzS7KcOodfFu75BBkp3ihgByDbLb'
...
subreddit_name = "memeyourenthusiasm"                 #Replace with your desired subreddit name
tag_string= "#Memeyourenthusiasm"        #Place to put your hastags, etc. Must be <=114 char
